function cars(input) {
        ...
        if (element.includes(' : ')) {
            ...
            if (element.includes('Refuel')) {
                ...
                if (sum > 75) {
                    ...
                    sum -= 75
                    console.log(`${givenCar} refueled with ${givenFuel - sum}`)
                } else {
            ...
            if (element.includes("Drive")) {
                ...
                if (givenFuel < result.get(givenCar)[1]) {
                    ...
                    console.log(`${givenCar} driven for ${distance} kilometers. ${givenFuel} liters.`)

                } else {
                    console.log('Not enough fuel to make that ride');
                }

                if (givenCar[0] >= 100000) {
    ...
    for (const [car, carInfo] of result) {
        console.log(`${car} --- ${carInfo[0]} --- ${carInfo[1]}`)
    }
