        ...
        if (element.includes(' : ')) {
            ...
            if (element.includes('Refuel')) {
                ...
                if (sum > 75) {
                    ...
                    sum -= 75;
                    console.log(`${givenCar} refuel with ${givenFuel - sum}`)
                } else {
                    result.get(givenCar)[1] = sum;
                    console.log(`${givenCar} refuel with ${givenFuel} liters.`)
                }
                ...
                if (givenFuel <= result.get(givenCar)[1]) {
                    ...
                    console.log(`${givenCar} driven for ${distance}. ${givenFuel} liters of fuel consumed.`)


                } else {
                    console.log(`Not enough fuel to make the ride.`);
                } if (result.get(givenCar)[0] >= 100000){
                    result.delete(givenCar)
                    console.log(`Time to sell ${givenCar}`);
                }
            }
